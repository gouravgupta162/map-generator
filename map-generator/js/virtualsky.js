...
/*
	...
	OPTIONS (default values in brackets):
		...
		gradientcolor - ('rgb(255,255,255)') - GRV
		bgcolor - ('rgb(255,255,255)') - GRV
*/
(function ($) {
...
function VirtualSky(input){
	...
	// this.dir = "template/create_poster/";
	this.dir = input.dir;
	...
	this.file = {
		stars: this.dir+"/json/stars.json",                 // Data for faint stars - 54 kB
		lines: this.dir+"/json/lines_latin.json",           // Data for constellation lines - 12 kB
		boundaries: this.dir+"/json/boundaries.json",       // Data for constellation boundaries - 20 kB
		showers: this.dir+"/json/showers.json",             // Data for meteor showers - 4 kB
		galaxy: this.dir+"/json/galaxy.json",               // Data for milky way - 12 kB
		planets: this.dir+"/js/virtualsky-planets.js" // Plugin for planet ephemeris - 12kB
	}
...
VirtualSky.prototype.draw = function(proj){
	...
	if(this.polartype){
		...
		if(!this.transparent){
			/*
				Gradient color change Gourav Gupta
				c.fillStyle = "rgba(61,51,21,1)";console.log("asd");
			*/
			console.log(this.col.gradientcolor);
	...
	if(this.hasGradient()){
		if(this.skygrad===undefined){
			...
			c.beginPath();
			/*
				Main Background-color change Gourav Gupta
				c.fillStyle = "rgba(61,51,21,1)";console.log("asd");
			*/
			// c.fillStyle = this.skygrad;
			c.fillStyle = "";//for transparent
